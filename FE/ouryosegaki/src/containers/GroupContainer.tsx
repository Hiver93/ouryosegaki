...
function GroupContainer(){
    ...
    const handleMemberSearch = () => {
        ...
        console.log("group con" + groupDetail.groupId)
        getGroupMembers(
        { groupId : groupDetail.groupId, password : groupDetail.password },
        (res: any) => {
            // 성공 콜백
            console.log("member search 서버 응답:", res.data);
    ...
    return (
        <div className="container-group">
            ...
            {isModalOpen === true && <AddMemberModal reGet={handleMemberSearch} clickClose={() => {
