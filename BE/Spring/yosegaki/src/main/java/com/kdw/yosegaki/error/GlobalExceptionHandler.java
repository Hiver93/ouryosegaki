...
import com.kdw.yosegaki.dto.ExceptionResDto;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(YosegakiException.class)
	public ResponseEntity<BaseResBody<ExceptionResDto>> handleException(YosegakiException ex){
		return new BaseResBody<>(
				new ExceptionResDto(ex.getErrorCode().getErrorCode(),ex.getMessage()), 
				ex.getMessage())
